	...
	void LinuxPainter::PaintPlayer(Plane* player)
	{
		int x = player->GetX();
		int y = player->GetY();
		masked_blit_8(dst, stride, VIDEO_WIDTH, VIDEO_HEIGHT, sprite_duck, SPRITE_W, SPRITE_H, x,y, TRANSPARENT_KEY);
	}
	void LinuxPainter::PaintEnemy(Plane* enemy)
	{
		int x = enemy->GetX();
		int y = enemy->GetY();
		masked_blit_8(dst, stride, VIDEO_WIDTH, VIDEO_HEIGHT, sprite_cow, SPRITE_W, SPRITE_H, x, y, TRANSPARENT_KEY);
	}
	...
	void LinuxPainter::PaintBullet(Bullet* bullet)
	{
		...
		masked_blit_8(dst, stride, VIDEO_WIDTH, VIDEO_HEIGHT, sprite_rabbit, SPRITE_W, SPRITE_H, x, y, TRANSPARENT_KEY);
